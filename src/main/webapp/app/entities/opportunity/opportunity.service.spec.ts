...
import { Opportunity } from '@/shared/model/opportunity.model';
...
describe('Service Tests', () => {
  describe('Opportunity Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Opportunity', async () => {
        const returnedFromService = {
          id: 123,
          createdDate: dayjs(currentDate).format(DATE_TIME_FORMAT),
          lastModifiedDate: dayjs(currentDate).format(DATE_TIME_FORMAT),
      ...
      it('should not create a Opportunity', async () => {
      ...
      it('should not update a Opportunity', async () => {
      ...
      it('should not partial update a Opportunity', async () => {
      ...
      it('should return a list of Opportunity', async () => {
        const returnedFromService = {
          title: 'BBBBBB',
          description: 'BBBBBB',
          status: 'BBBBBB',
      ...
      it('should not return a list of Opportunity', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Opportunity', async () => {
