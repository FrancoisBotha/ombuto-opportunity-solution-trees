 ...
 * delete: node create, move, product reorder and cascade delete, product create and edit (and a
 * product changing team), appending a link or an open question, field patches (which write history), and
