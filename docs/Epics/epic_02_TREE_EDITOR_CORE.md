...
> **Superseded by [Epic 11: OST Tree Builder](epic_11_OST_TREE_BUILDER.md) (2026-09-20).** The
> Vue Flow Tree Builder delivered this scope in revised form and replaced the custom SVG tree
> editor built for it. Kept for history; do not plan work from it.
