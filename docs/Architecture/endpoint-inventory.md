...
| `OutcomeResource`         | `/api/outcomes`          | GET, GET/{id}, POST, PUT/{id}, PATCH/{id}, DELETE/{id} | team-owned (via Product)             | `ROLE_ADMIN`                                                                                                                                                      |
| `OpportunityResource`     | `/api/opportunities`     | GET, GET/{id}, POST, PUT/{id}, PATCH/{id}, DELETE/{id} | team-owned (via Outcome)             | `ROLE_ADMIN`                                                                                                                                                      |
...
| `SolutionResource`        | `/api/solutions`         | GET, GET/{id}, POST, PUT/{id}, PATCH/{id}, DELETE/{id} | team-owned (via Opportunity)         | `ROLE_ADMIN`                                                                                                                                                      |
