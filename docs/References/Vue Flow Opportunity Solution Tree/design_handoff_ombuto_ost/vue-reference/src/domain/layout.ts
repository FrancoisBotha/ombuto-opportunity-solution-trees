...
export interface Placed { x: number; y: number; w: number; h: number; depth: number }
...
export function layoutTree(
  nodes: OstNode[],
  opts: { roots: string[]; collapsed: Record<string, boolean> },
